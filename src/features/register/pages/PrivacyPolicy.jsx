    ...
    <div className="info-agreement-container">
      ...
      <div className="info-agreement-form">
        ...
        <p className="register-agreement-notice">
          ...
          <br />
          <br />
          * 개인정보 수집∙이용에 대한 동의를 거부할 수 있으며, 거부할 경우
          서비스 이용이 제한됩니다.
          <br />
          서비스 이용 과정에서 부정이용방지, 비인가 사용 방지, 통계 및 서비스
          품질 향상 목적으로 단말기
          <br />
          정보(OS, 모델명 등), IP주소, 쿠키, 서비스 이용 기록(방문일시,
          접속기록) 정보가 자동으로 생성되
          <br />
          어 수집될 수 있습니다. 자동으로 생성되어 수집된 정보는 서비스 제공
          기간동안 보유 및 이용하며,
          <br />
        ...
        <p className="register-agreement-notice">
          ...
          <span className="register-notice-span">
            본 약관은 회원(Youth! 서비스 약관에 동의한 마케팅 수신 동의를
            말하며, 이하 “회원”)이
          </span>
          <br />
          <span className="register-notice-span">
            주식회사 Youth!(이하 “회사”)가 제공하는 서비스(이하 “서비스”)를
            이용함에 있어 회사와 회원의 권리/의무 및 책임사항
          </span>
          <br />
          <span className="register-notice-span">
            을 규정함을 목적으로 합니다.
