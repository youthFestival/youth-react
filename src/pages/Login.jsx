        ...
        <div className="login-contents">
          ...
          <div className="login-maintain-container">
            <label htmlFor="login-maintain-checkbox">
              <input type="checkbox" className="login-maintain-checkbox" />
              로그인 상태 유지
            </label>
          </div>
          ...
          <div className="login-userfind-register">
            <div className="userfind-register-form">
              <div className="login-go-findid-field">
                <button type="button" className="login-go-findid-btn">
                  아이디 찾기
                </button>
              </div>

              <div className="login-go-findpw-field">
                <button type="button" className="login-go-findpw-btn">
                  비밀번호 찾기
                </button>
              </div>

              <div className="login-go-register-field">
                <button type="button" className="login-go-register-btn">
                  회원가입
                </button>
              </div>
            </div>
